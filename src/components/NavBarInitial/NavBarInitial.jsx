        ...
        <div
            ...
            <nav>
                <div
                    ...
                    <div
                        className='container-NavBarInitial-main-menu-media650'>
                        <input
                            type="checkbox"
                            id='nav' />
                        <label
                            onClick={() => setModalOpenCloseMenu(!modalOpenCloseMenu)}
                            id='container-NavBarInitial-main-label'
                            htmlFor="nav"
            ...
            <div
                ...
                className='container-NavBarInitial-search-media650'>
            ...
            <div
                ...
                className='container-NavBarInitial-main-openMenu-media650'>
                <ul>
                    <li

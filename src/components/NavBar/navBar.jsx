  ...
  return (
    <nav className="navbar">
      ...
      {!token
        ...
        :
        <div className='container-NavBarProfessional-main'>
          <img
          ...
          <div
            ...
            <h3>
              {!userUnifiedTable
                ...
                ""
                :
                userUnifiedTable.user.name || userUnifiedTable.user.email}
            </h3>
            <img
      ...
      {!token
        ...
        :
        <div style={modalOpenCloseMenu ? { display: 'flex' } : { display: 'none' }}
